//  Lection13Continue2ViewController.swift
//  NodaTrainer
//
...
class Lection13Continue2ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"0016 3", withExtension: "mp3")
