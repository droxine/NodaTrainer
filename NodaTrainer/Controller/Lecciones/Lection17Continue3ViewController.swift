//
//  Lection17Continue3ViewController.swift
//  NodaTrainer
//
...
class Lection17Continue3ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"2da mayor descendente", withExtension: "mp3")
