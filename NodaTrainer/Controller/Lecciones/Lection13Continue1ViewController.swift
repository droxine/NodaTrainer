//  Lection13Continue1ViewController.swift
//  NodaTrainer
//
...
class Lection13Continue1ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"0016 2", withExtension: "mp3")
