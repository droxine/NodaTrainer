//
//  Lection21Continue4ViewController.swift
//  NodaTrainer
//
...
class Lection21Continue4ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"extra-5-me-enamore-de-ti", withExtension: "mp3")
    ...
    @IBAction func goNext(_ sender: Any) {
        let controllerTravel = self.storyboard?.instantiateViewController(withIdentifier: "lection21Continue5") as! Lection21Continue5ViewController
