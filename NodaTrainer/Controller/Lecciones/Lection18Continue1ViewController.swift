//
//  Lection18Continue1ViewController.swift
//  NodaTrainer
//
...
class Lection18Continue1ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"3ra menor ascendente", withExtension: "mp3")
    ...
    @IBAction func goNext(_ sender: Any) {
        let controllerTravel = self.storyboard?.instantiateViewController(withIdentifier: "lection18Continue2") as! Lection18Continue2ViewController
