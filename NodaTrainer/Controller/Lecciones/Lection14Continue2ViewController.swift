//  Lection14Continue2ViewController.swift
//  NodaTrainer
//
...
class Lection14Continue2ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"0017 3", withExtension: "mp3")
