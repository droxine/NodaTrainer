//  Lection12Continue3ViewController.swift
//  NodaTrainer
//
...
class Lection12Continue3ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"0015 4", withExtension: "mp3")
