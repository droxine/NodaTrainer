//  Lection11Continue3ViewController.swift
//  NodaTrainer
//
...
class Lection11Continue3ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"0014 4", withExtension: "mp3")
