//  Lection6Continue3ViewController.swift
//  NodaTrainer
//
...
class Lection6Continue3ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"0009 Do, re,  mi, fa, sol, la, 4", withExtension: "mp3")
