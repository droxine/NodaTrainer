//  Lection14Continue3ViewController.swift
//  NodaTrainer
//
...
class Lection14Continue3ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"0017 4", withExtension: "mp3")
