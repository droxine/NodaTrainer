//
//  Lection21Continue3ViewController.swift
//  NodaTrainer
//
//  Created by walter on 6/9/19.
...
class Lection21Continue3ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"extra-4-ave-maria", withExtension: "mp3")
    ...
    @IBAction func goNext(_ sender: Any) {
        let controllerTravel = self.storyboard?.instantiateViewController(withIdentifier: "lection21Continue4") as! Lection21Continue4ViewController
