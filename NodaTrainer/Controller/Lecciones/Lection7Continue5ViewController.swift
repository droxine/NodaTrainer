//  Lection7Continue5ViewController.swift
//  NodaTrainer
//
...
class Lection7Continue5ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"0010 Do, re,  mi, fa, sol, la, 6", withExtension: "mp3")
