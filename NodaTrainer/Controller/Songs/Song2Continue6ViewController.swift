//
//  Song2Continue6ViewController.swift
//  NodaTrainer
//
...
class Song2Continue6ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"7", withExtension: "mp3")
    ...
    @IBAction func goNext(_ sender: Any) {
        let controllerTravel = self.storyboard?.instantiateViewController(withIdentifier: "song2Continue7") as! Song2Continue7ViewController
