//
//  Song2Continue7ViewController.swift
//  NodaTrainer
//
//  Created by sangeles on 1/15/19.
...
class Song2Continue7ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"8", withExtension: "mp3")
    ...
    @IBAction func goNext(_ sender: Any) {
        let controllerTravel = self.storyboard?.instantiateViewController(withIdentifier: "song2Continue8") as! Song2Continue8ViewController
