//
//  Song2Continue8ViewController.swift
//  NodaTrainer
//
//  Created by sangeles on 1/16/19.
...
class Song2Continue8ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"9", withExtension: "mp3")
    ...
    @IBAction func goNext(_ sender: Any) {
        let controllerTravel = self.storyboard?.instantiateViewController(withIdentifier: "song2Continue9") as! Song2Continue9ViewController
