//
//  Song2Continue12ViewController.swift
//  NodaTrainer
//
...
class Song2Continue12ViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"13", withExtension: "mp3")
    ...
    @IBAction func goNext(_ sender: Any) {
        let controllerTravel = self.storyboard?.instantiateViewController(withIdentifier: "song2Continue13") as! Song2Continue13ViewController
