//
//  Song2CompletedViewController.swift
//  NodaTrainer
//
...
class Song2CompletedViewController: UIViewController {
    ...
    @IBAction func playSound(_ sender: Any) {
        let sound = Bundle.main.url(forResource:"El tamborilero", withExtension: "mp3")
